...
INSERT INTO campaign(uuid, name, description, created_at, creator_user_id) VALUES (UNHEX(REPLACE('3f2877a0-4a2b-4e5d-8b5e-3b5a07859a05', '-', '')), 'Z', 'Z', '2024-02-04 22:00:00', 1)
...
INSERT INTO player_character(experience_points, campaign_id, class_id, id, race_id, user_id, uuid) VALUES (900, 1, 1, 1, 1, 1, UNHEX(REPLACE('83f8634b-33df-4f67-b659-66b55cd8534f', '-', '')))